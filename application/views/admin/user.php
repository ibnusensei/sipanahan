                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" max="10" min="0" readonly class="form-control" name="n1" value="<?= (!empty($nilai->n1)) ? $nilai->n1 : '' ?>" placeholder="Stance">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Nocking</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n2" value="<?= (!empty($nilai->n2)) ? $nilai->n2 : '' ?>" placeholder="Nocking">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Set Up</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n3" value="<?= (!empty($nilai->n3)) ? $nilai->n3 : '' ?>" placeholder="Set Up">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Drawing</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n4" value="<?= (!empty($nilai->n4)) ? $nilai->n4 : '' ?>" placeholder="Drawing">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Anchoring</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n5" value="<?= (!empty($nilai->n5)) ? $nilai->n1 : '' ?>" placeholder="Anchoring">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Holding</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n6" value="<?= (!empty($nilai->n6)) ? $nilai->n6 : '' ?>" placeholder="Holding">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Aiming</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n7" value="<?= (!empty($nilai->n7)) ? $nilai->n7 : '' ?>" placeholder="Aiming">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Release</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n8" value="<?= (!empty($nilai->n8)) ? $nilai->n8 : '' ?>" placeholder="Release">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Follow Through</label>
                                <input type="number" max="10" min="0" readonly class="form-control" name="n9" value="<?= (!empty($nilai->n9)) ? $nilai->n9 : '' ?>" placeholder="Follow Through">
                            </div>
                        </div>
                    </div>

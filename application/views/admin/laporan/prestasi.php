        ...
        <div class="white-box">
            <div class="row">
                ...
                <div class="col-md-6 text-right" >
                    <form role="search" action="<?= site_url('export/prestasi') ?>" target="_blank" method="get" class="">
                        ...
                        <input type="hidden" value="<?php echo (!empty($_GET['tingkat'])) ? $_GET['tingkat'] : '' ?>" name="tingkat">
                        ...
                        <a name="" id="" class="btn btn-primary d-none" href="#" role="button" data-toggle="modal" data-target="#create"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</a>
                        <?php endif ?>
                    </form>
                </div>
                <div class="col-md-12">
                    <form role="search" action="<?php echo site_url('laporan/prestasi')?>" method="get" class="app-search d-flex me-5">
                        ...
                        <input type="text" placeholder="Cari Nama..." value="<?php echo (!empty($_GET['search'])) ? $_GET['search'] : '' ?>" name="search" class="form-control mt-0 mr-2">
                        <select class="form-control" name="tingkat" >
                            <option value="">Pilih Tingkat</option>
                            <?php foreach ($tingkat as $x => $d) : ?>
                                <option <?php echo (!empty($_GET['tingkat']) && $_GET['tingkat'] == $x+1) ? 'selected' : '' ?> value="<?= $x+1 ?>"><?= $d ?></option>
                            <?php endforeach; ?>
                        </select>
                        <button type="submit" class="btn btn-link"><i class="fa fa-search"></i></button>
                        <a name="" id="" class="btn btn-link text-danger" href="<?php echo site_url('laporan/prestasi')?>" role="button"><i class="fa fa-times"></i></a>
                    </form>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    <span>  
                                        <a href="<?php echo site_url('export/surat_prestasi/'.$data->id); ?>" target="_blank" >

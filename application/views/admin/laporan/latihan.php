...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="box-title">Data Laporan <?= $title ?></h3>
                    <p class="text-muted">Sistem Informasi Atlet Panahan Banjarmasin</p>
                </div>
                <div class="col-md-6 text-right" >
                    <form role="search" action="<?= site_url('export/latihan') ?>" target="_blank" method="get" class="">
                ...
                <div class="col-md-6">
                    <form role="search" action="<?php echo site_url('laporan/latihan')?>" method="get" class="app-search d-flex me-5">
                        <input type="date" placeholder="" value="<?php echo (!empty($_GET['a'])) ? $_GET['a'] : '' ?>" name="a" class="form-control mt-0 w-50 mr-2">
                        <input type="date" placeholder="Cari Nama..." value="<?php echo (!empty($_GET['b'])) ? $_GET['b'] : '' ?>" name="b" class="form-control mt-0 w-50">
                        <button type="submit" class="btn btn-link"><i class="fa fa-search"></i></button>
                        <a name="" id="" class="btn btn-link text-danger" href="<?php echo site_url('laporan/latihan')?>" role="button"><i class="fa fa-times"></i></a>
                    </form>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    <span>  
                                        <a style="cursor: pointer;"class="btn btn-sm btn-info mr-1 float-left" href="<?= site_url('export/latihan/'.$data->id) ?>" target="_blank">

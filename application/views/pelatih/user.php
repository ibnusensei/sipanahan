            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right" >
                    ...
                    <a href="<?php echo site_url('export/penilaian'); ?>" >
                        <button class="btn btn-info mr-1 d-none" style="color: #fafafa;">
                ...
                <form role="search" action="<?php echo site_url('pelatih/penilaian')?>" method="get" class="app-search d-flex me-5">
                    ...
                    <a name="" id="" class="btn btn-link text-danger" href="<?php echo site_url('pelatih/penilaian')?>" role="button"><i class="fa fa-times"></i></a>
                </form>
                </div>
            </div>
